        ...
        <div class="main-box">
            <div class="form-box">
                ...
                <div class="button-box">
                    ...
                    <button id="log" type="button" class="toggle-btn" :class="{ active: isLoginActive }" @click="login">
                        登 录
                    </button>
                    <button id="reg" type="button" class="toggle-btn" :class="{ active: !isLoginActive }"
                        @click="register">
                        注 册
                    </button>
                </div>
                ...
                <!-- 登录表单 -->
                <form id="login" class="input-group" ref="loginFormRef" @submit.prevent="handleLogin">
                    <input type="text" class="input-field" placeholder="Username" v-model="loginForm.username"
                        required />
                    ...
                    <input type="submit" class="submit-btn" value="登 录" />
                </form>
                <!-- 注册表单 -->
                <form id="register" class="input-group" ref="registerFormRef" @submit.prevent="handleRegister">
                    <input type="text" class="input-field" placeholder="Username" v-model="registerForm.username"
                        required />
                    <!-- <input type="email" class="input-field" placeholder="Email" v-model="registerForm.email" required /> -->
                    <input type="password" class="input-field" placeholder="Password" v-model="registerForm.password"
                        required />
...
<script>
import { ref } from "vue";
import axios from "@/plugins/axios"; // 确保 axios 已正确配置
...
export default {
    setup() {
        ...
        const login = () => {
            ...
            loginFormRef.value.style.left = "0px";
            registerFormRef.value.style.left = "500px";
        ...
        const register = () => {
            ...
            loginFormRef.value.style.left = "-500px";
            registerFormRef.value.style.left = "0px";
        ...
        const handleRegister = async () => {
            if (registerForm.value.password !== registerForm.value.confirmPassword) {
                registerError.value = "密码和确认密码不一致";
                return;
            }
